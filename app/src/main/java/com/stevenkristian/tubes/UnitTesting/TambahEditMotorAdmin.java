...
public class TambahEditMotorAdmin extends Fragment implements CreateView{
    ...
    public String getMerk() {
        return txtMerk.getText().toString();
    }

    @Override
    public void showMerkError(String message) {
        txtMerk.setError(message);
    }

    @Override
    public String getPlat() {
        return txtPlat.getText().toString();
    }

    @Override
    public void showPlatError(String message) {
        txtPlat.setError(message);
    }

    @Override
    public String getWarna() {
        return txtWarna.getText().toString();
    }

    @Override
    public void showWarnaError(String message) {
        txtWarna.setError(message);
    }

    @Override
    public String getTahun() {
        return txtTahun.getText().toString();
    }

    @Override
    public void showTahunError(String message) {
        txtTahun.setError(message);
    }
    ...
    public String getHarga() {
        return txtHarga.getText().toString();
    }

    @Override
    public void showHargaError(String message) {
        txtHarga.setError(message);
    }
    ...
    public void startActivity() {
        new ActivityUtil(view.getContext()).startActivity();
    }
